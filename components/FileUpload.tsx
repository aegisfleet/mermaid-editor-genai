    ...
    <div className="mb-4 flex flex-col space-y-2">
      <div className="flex flex-wrap items-center gap-2">
        <select
          ...
          className="px-4 py-2 rounded-lg shadow-sm bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200"
        >
        ...
        {updateType === 'new' && (
          <input
            ...
            className="px-4 py-2 rounded-lg shadow-sm bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 flex-grow"
          />
        )}
        <input
          type="file"
        ...
        <button
          ...
          className="px-4 py-2 bg-green-500 text-white rounded-lg shadow-md hover:bg-green-600 transition-colors dark:bg-green-600 dark:hover:bg-green-700"
        >
          Upload Files
        </button>
        <button
